						...
						<div className="banner-wrapper">
							...
							<div className="banner-content" onClick={this.closeSidebar}>
								<div className="banner-text-container col-md-12 col-lg-6">
									...
									<p>
										Olá, o meu nome é Hugo Veloso e trabalho com Desenvolvimento de Websites, Design e Marketing Digital
				...
				<div className="section-container" id="services-section">
					...
					<div className="services-description">
						<p>
							...
							um site/projecto de qualidade. <br /> A vantagem de trabalhar comigo é principalmente a comunicação
							directa e o entendimento transversal de design, desenvolvimento e marketing que resultam num trabalho mais
							coeso com os objectivos definidos pelo cliente. Há também a vantagem de que com uma equipa reduzida, os
							custos são também reduzidos.
